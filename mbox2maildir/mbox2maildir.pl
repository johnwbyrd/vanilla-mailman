#!/usr/bin/perl -w
#
# mbox2maildir.pl      Converts Mbox mailboxes to Maildir format.
#
# Public domain.
#
#
...
#my $name = 'jbyrd';
#my $homedir = 'K:/Git/mail-to-db/Module/Emails-Parser/';
...
sub convert
{
	...
	my $previous_line_was_empty = 1;
        ...
        while(<MBOX>)
        {
            ...
            if ( /^From - /
		# Doesn't matter if previous line was empty or not!
